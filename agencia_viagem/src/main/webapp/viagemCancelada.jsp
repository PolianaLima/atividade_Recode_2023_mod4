...
<head>
    ...
    <title>Viagem cancelada com sucesso</title>
...
<main class="container" style="min-height: 76vh">
    <div class="d-sm-flex flex-row align-items-center">
        ...
        <div>
            <p class="text-danger fw-bolder ">Sua reserva foi cancelada com sucesso!!</p>
            <a href="listarreservas" class="fw-bolder mb-5 " style="text-decoration: none">Ver minhas viagens!!</a>
            <h3>Ops! E uma pena que não viajara conosco!</h3>
            <p>Mais não desanime, aproveite as ofertas em voos e planeje sua proxima viagem.</p>
